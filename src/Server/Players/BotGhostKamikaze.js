...
BotGhostKamikaze.prototype.iterateBlobs = function(enemyArmy) {
...
BotGhostKamikaze.prototype._lineWeWantOurBlobOn = function(enemyArmy) {
	const lines = [];
	for (let i=0 ; i<3 ; i++) {
...
BotGhostKamikaze.prototype._whoMovesToLine = function(line) {
	let id = -1;
	let distance = 1000;
