...
const CardsMenu = ({cards, randomCards, chooseCards, displayContainer, displayAlert}) => {
	...
	return (
		<div id="cardsMenu" className={noCard ? "noCard" : ""}>
			...
			<div id="cardsChoose" onClick={() => {displayContainer("CardsSwitch")}}><img src="Assets/Cards.png" /><span> Choose your cards </span></div>
...
const Menu = ({cards, randomCards, displayContainer, displayAlert, startGame, startMatchMaking}) => {
	...
	return (
		<div className="menu">
			<CardsMenu className="cardsMenuContainer" randomCards={randomCards} cards={cards} displayContainer={displayContainer} displayAlert={displayAlert} />
			<div id="start">
				<div className="blank"></div>
